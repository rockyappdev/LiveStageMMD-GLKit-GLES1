...
GLuint SZGLLoadTextureImpl_Apple( NSData *data, CGSize *imageSize, CGSize *textureSize)
{
    ...
    if (data != nil) {
        ...
        ret = _GLLoadTextureFromCGImage([image CGImage], [image imageOrientation], imageSize, textureSize);
    }
...
static GLuint SZGLLoadTextureImpl_PVR(NSData *data, CGSize *imageSize, CGSize *textureSize)
{
    if (!data) {
        return -1;
    }
...
GLuint SZGLLoadTexture(NSString *imagePath, CGSize *imageSize, CGSize *textureSize, NSData *data)
{
    if ([[[imagePath pathExtension] lowercaseString] isEqualToString:@"pvr"]) {
        return SZGLLoadTextureImpl_PVR(data, imageSize, textureSize);
    }
    
    return SZGLLoadTextureImpl_Apple(data, imageSize, textureSize);
}
